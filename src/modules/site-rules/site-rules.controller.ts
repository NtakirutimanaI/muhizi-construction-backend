...
export class SiteRulesController {
    ...
    @ApiOperation({ summary: 'Create a site rule', description: 'Create a new site rule (admin/site manager)' })
    ...
    @UseGuards(JwtAuthGuard, RolesGuard)
    @Roles(Role.ADMIN, Role.STOREKEEPER)
    @ApiOperation({ summary: 'Get all site rules (admin)', description: 'Retrieve all site rules with details (admin/site manager)' })
    ...
    @UseGuards(JwtAuthGuard, RolesGuard)
    @Roles(Role.ADMIN, Role.STOREKEEPER)
    @ApiOperation({ summary: 'Update a site rule', description: 'Update an existing site rule (admin/site manager)' })
    @ApiBody({ type: CreateSiteRuleDto })
